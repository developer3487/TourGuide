...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> mapRoute) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(mapRoute.get(0)).color(RED).width(10);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(mapRoute.get(0)).color(Color.BLACK).width(10);
        ...
        percentageCompletion.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                foregroundPolyline.setColor(RED);
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), RED, Color.BLACK);
        ...
        ObjectAnimator foregroundRouteAnimator = ObjectAnimator.ofObject(this,
                "routeIncreaseForward", new RouteEvaluator(), mapRoute.toArray());
