...
import com.app.tourguide.utils.player.BetterVideoPlayer
import com.app.tourguide.utils.player.captions.CaptionsView
...
internal interface IBetterVideoPlayer {
     ...
     */
    fun getToolbar(): android.widget.Toolbar
